...
The data set in this repository (tidydata.txt) contains the means of 68 variables
...
run_analysis.R: R script that created tidy_data.txt
codebook.pdf: Descriptions of all variables in tidy_data.txt 
...
14. New data was constructed consisting of means for each subject and activity.
15. Convert activity code to activity label   
